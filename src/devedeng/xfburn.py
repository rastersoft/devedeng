...
class xfburn(devedeng.executor.executor):
    ...
    def check_is_installed():
        try:
            handle = subprocess.Popen(["xfburn", "-h"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    ...
    def burn(self, file_name):
        ...
        self.command_var = ["xfburn", "-i", file_name]
